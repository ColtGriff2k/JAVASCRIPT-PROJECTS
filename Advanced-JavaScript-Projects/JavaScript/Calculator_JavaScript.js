...
const Calculator = {
    ...
    Display_Value: '0',
    //This will hold the first operand for any expessions, we set it to null for now.
    First_Operand: null,
...
function Input_Decimal(dot) {
    //This ensures that accidental clicking of the decimaal point doesn't
...
function Handle_Operator(Next_Operator) {
    ...
    //Checks if and operator already exists and if Wait_Second_operand is true,
