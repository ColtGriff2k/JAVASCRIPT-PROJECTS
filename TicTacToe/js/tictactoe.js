// This variable keeps rack of whose turn it is.
let activePlayer = 'X';
...
function checkWinConditions() {
    ...
    //This function check is an array includes 3 strings. It is used to check for
    //each win condition.
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 varibales we pass are all inlcuded in our array, then
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        y1 = coordY1,
        //This line indicates where the end of a lines yxaxis is.
        x2 = coordX2,
    ...
    function animateLineDrawing() {
        ...
        //This condition checks if we've reach endpoints.
        if (x1 <= x2 && y1 <= y2) {
        ...
        //This condition is similar to the one one above.
        //This is necessary for the 6,4,2 win condition.
        if (x1 <= x2 && y1 <= y2) {
            if (x < x2) { x += 10; }
            if (y > y2) { y -= 10; }
